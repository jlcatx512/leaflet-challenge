...
// NB this code is broken up in to two pars.
// First, the functions that make up the immediately invoked function.
// Second, the immediately invoked function. --> await call because must wait for data to load.

// Function create features from earthquakeData.
// NB earthquakeData --> data.features.
// The original data response was geoJSON FeatureCollections.
// Need to extract the features key only.
...
function createEarthquakeFeatures(earthquakeData) {
    ...
    // const faultlines = L.geoJSON(tectonicData, {
